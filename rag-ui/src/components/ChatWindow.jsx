        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center py-20">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-md">
              Upload documents to start asking questions and get intelligent answers powered by your private data.
            </p>
            <div className="mt-8 flex flex-col space-y-2 text-sm text-gray-500 dark:text-gray-400">
